...
{
    int boundarycondition1 = BoundaryConditionPage.Parameter1;
    int section1 = SectionPage.Parameter1;
    int length1 = LengthPage.Parameter1;
    int bracing1 = BracingPage.Parameter1;

    int boundarycondition2 = BoundaryConditionPage.Parameter2;
    int section2 = SectionPage.Parameter2;
    int length2 = LengthPage.Parameter2;
    int bracing2 = BracingPage.Parameter2;
    ...
    private int file1Count;
    private int file2Count;
    ...
    public void Column1Renew()
    {
        Graph_Force.valueList1 = new List<float> { 0 };
        string pathOfFile1 = dataLocation + @"/BoundaryCondition" + boundarycondition1 + @"/Section" + section1 + @"/Length" + length1 + @"/Bracing" + bracing1 + @"/forceresultant.txt";
        file1 = new StreamReader(pathOfFile1, Encoding.Default);
    }
    public void Column2Renew()
    {
    ...
    private List<float> ChanegeValueList2()
    {
        string valueLine2 = file2.ReadLine();
    ...
    private void ShowGraph(List<float> valueList1, List<float> valueList2, IGraphVisual graphVisual1, IGraphVisual graphVisual2, int maxVisibleValueAmount = -1, Func<int, string> getAxisLabelX = null, Func<float, string> getAxisLabelY = null)
    {
        ...
        for (int i = 0; i <= separatorCount; i++)
        {
            ...
            //gameObjectsList2.Add(labelY.gameObject);
        }
