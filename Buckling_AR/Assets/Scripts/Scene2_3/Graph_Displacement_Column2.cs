...
public class Graph_Displacement_Column2 : MonoBehaviour
{
    ...
    public Font Font;
    private static Graph_Displacement_Column2 instance;
    ...
    void Update()
    {
        ...
        ShowGraph(Graph_Displacement.valueList2, this.graphVisual2, -1, (float _i) => Mathf.RoundToInt(_i) + "", (int _i) => _i.ToString());
    ...
    public void ShowMaxDisplacement()
    {
        ...
        MaxDispGameObject2.transform.localPosition = new Vector2(320, 40);
        ...
        MaxDisplacementLocationObject2.transform.localPosition = new Vector2(570, 40);
    ...
    private void ShowGraph(List<float> valueList2, IGraphVisual graphVisual2, int maxVisibleValueAmount = -1, Func<float, string> getAxisLabelX = null, Func<int, string> getAxisLabelY = null)
    {
